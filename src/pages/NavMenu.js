                    ...
                    <ul>
                        ...
                        <li>
                            <Link href={`/MiPerfil/${resultado}`}
                                  className={router.pathname === `/MiPerfil/${resultado}` ? styles.active : ''}>
                                Il Mio Profilo
                            </Link>
                        </li>
                        <li>
                            <Link href={`/Match/${resultado}`}
                                  className={router.pathname === `/Match/${resultado}` ? styles.active : ''}>
                                Incontro
                            </Link>
                        </li>
                        <li hidden={true}>
                            <Link href={`/PerfilUsuario/${resultado}`}
                                  className={router.pathname === `/PerfilUsuario/${resultado}` ? styles.active : ''}>
                                Profilo Utente
                            </Link>
                        </li>
                        <li>
                            <Link href={`/Recibidas/${resultado}`}
                                  className={router.pathname === `/Recibidas/${resultado}` ? styles.active : ''}>
                                Inviti Ricevuti
                            </Link>
                        </li>
                        <li>
